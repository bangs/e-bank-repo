...
//		if (productInstance.save(flush: true)) {
//			flash.message = "${message(code: 'default.created.message', args: [message(code: 'product.label', default: 'Product'), productInstance.id])}"
//			redirect(action: "show_m", id: productInstance.id)
//		}
//		else {
//			render(view: "create_m", model: [productInstance: productInstance])
//		}
//	}
		...
		if (productInstance) {
			if (params.version) {
				...
				if (productInstance.version > version) {
					...
					productInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'product.label', default: 'Product')] as Object[], "Another user has updated this Product while you were editing")
					render(view: "edit_m", model: [productInstance: productInstance])
					return
				}
			}
			productInstance.properties = params
