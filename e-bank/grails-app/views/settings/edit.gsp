	...
	<g:form method="post" class="form-horizontal" >
		...
		<g:hiddenField name="version" value="${settingsInstance?.version}" />
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'startOfWeek', 'error')}">
							<label for="startOfWeek"><g:message code="settings.startOfWeek.label" default="Start Of Week" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'offDays', 'error')}">
							<label for="offDays"><g:message code="settings.offDays.label" default="Off Days" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'baseCurrency', 'error')}">
							<label for="baseCurrency"><g:message code="settings.baseCurrency.label" default="Base Currency" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'customCurrency', 'error')}">
							<label for="customCurrency"><g:message code="settings.customCurrency.label" default="Custom Currency" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'minimumInterest', 'error')}">
							<label for="minimumInterest"><g:message code="settings.minimumInterest.label" default="Minimum Interest" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'maximumInterest', 'error')}">
							<label for="maximumInterest"><g:message code="settings.maximumInterest.label" default="Maximum Interest" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'interestDays', 'error')}">
							<label for="interestDays"><g:message code="settings.interestDays.label" default="Interest Days" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'minimumIndebtnessRatio', 'error')}">
							<label for="minimumIndebtnessRatio"><g:message code="settings.minimumIndebtnessRatio.label" default="Minimum Indebtness Ratio" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'maximumIndebtnessRatio', 'error')}">
							<label for="maximumIndebtnessRatio"><g:message code="settings.maximumIndebtnessRatio.label" default="Maximum Indebtness Ratio" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'minimumNewClientAge', 'error')}">
							<label for="minimumNewClientAge"><g:message code="settings.minimumNewClientAge.label" default="Minimum New Client Age" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'maximumNewClientAge', 'error')}">
							<label for="maximumNewClientAge"><g:message code="settings.maximumNewClientAge.label" default="Maximum New Client Age" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'sessionTimeoutMinutes', 'error')}">
							<label for="sessionTimeoutMinutes"><g:message code="settings.sessionTimeoutMinutes.label" default="Session Timeout Minutes" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'batchJobSize', 'error')}">
							<label for="batchJobSize"><g:message code="settings.batchJobSize.label" default="Batch Job Size" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'maxDisbursalLimit', 'error')}">
							<label for="maxDisbursalLimit"><g:message code="settings.maxDisbursalLimit.label" default="Max Disbursal Limit" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'ageCheckEnabled', 'error')}">
							<label for="ageCheckEnabled"><g:message code="settings.ageCheckEnabled.label" default="Age Check Enabled" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'allowInstallmentsAboveAmountDue', 'error')}">
							<label for="allowInstallmentsAboveAmountDue"><g:message code="settings.allowInstallmentsAboveAmountDue.label" default="Allow Installments Above Amount Due" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'allowInstallmentsBelowAmountDue', 'error')}">
							<label for="allowInstallmentsBelowAmountDue"><g:message code="settings.allowInstallmentsBelowAmountDue.label" default="Allow Installments Below Amount Due" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'groupLoansAllowed', 'error')}">
							<label for="groupLoansAllowed"><g:message code="settings.groupLoansAllowed.label" default="Group Loans Allowed" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: settingsInstance, field: 'uploadStorageDirectory', 'error')}">
							<label for="uploadStorageDirectory"><g:message code="settings.uploadStorageDirectory.label" default="Upload Storage Directory" /></label>
							<div class="controls">
