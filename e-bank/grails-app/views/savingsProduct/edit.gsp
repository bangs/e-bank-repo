...
<section id="edit" class="first">
	...
	<g:form method="post" class="form-horizontal" >
		...
		<g:hiddenField name="version" value="${savingsProductInstance?.version}" />
				
										
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'name', 'error')}">
							<label for="name"><g:message code="savingsProduct.name.label" default="Name" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'shortName', 'error')}">
							<label for="shortName"><g:message code="savingsProduct.shortName.label" default="Short Name" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'description', 'error')}">
							<label for="description"><g:message code="savingsProduct.description.label" default="Description" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'category', 'error')}">
							<label for="category"><g:message code="savingsProduct.category.label" default="Category" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'startDate', 'error')}">
							<label for="startDate"><g:message code="savingsProduct.startDate.label" default="Start Date" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'endDate', 'error')}">
							<label for="endDate"><g:message code="savingsProduct.endDate.label" default="End Date" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'applicableFor', 'error')}">
							<label for="applicableFor"><g:message code="savingsProduct.applicableFor.label" default="Applicable For" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'typeOfDeposits', 'error')}">
							<label for="typeOfDeposits"><g:message code="savingsProduct.typeOfDeposits.label" default="Type Of Deposits" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'recommendedDepositAmount', 'error')}">
							<label for="recommendedDepositAmount"><g:message code="savingsProduct.recommendedDepositAmount.label" default="Recommended Deposit Amount" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'maxAmountPerWithdrawal', 'error')}">
							<label for="maxAmountPerWithdrawal"><g:message code="savingsProduct.maxAmountPerWithdrawal.label" default="Max Amount Per Withdrawal" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'interestRate', 'error')}">
							<label for="interestRate"><g:message code="savingsProduct.interestRate.label" default="Interest Rate" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'interestCalculationBalance', 'error')}">
							<label for="interestCalculationBalance"><g:message code="savingsProduct.interestCalculationBalance.label" default="Interest Calculation Balance" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'interestCalculationTimePeriod', 'error')}">
							<label for="interestCalculationTimePeriod"><g:message code="savingsProduct.interestCalculationTimePeriod.label" default="Interest Calculation Time Period" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'interestPostingFrequency', 'error')}">
							<label for="interestPostingFrequency"><g:message code="savingsProduct.interestPostingFrequency.label" default="Interest Posting Frequency" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'minInterestCalculationBalance', 'error')}">
							<label for="minInterestCalculationBalance"><g:message code="savingsProduct.minInterestCalculationBalance.label" default="Min Interest Calculation Balance" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'depositGLCode', 'error')}">
							<label for="depositGLCode"><g:message code="savingsProduct.depositGLCode.label" default="Deposit GLC ode" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'interestGLCode', 'error')}">
							<label for="interestGLCode"><g:message code="savingsProduct.interestGLCode.label" default="Interest GLC ode" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: savingsProductInstance, field: 'status', 'error')}">
							<label for="status"><g:message code="savingsProduct.status.label" default="Status" /></label>
							<div class="controls">
								...
								<span class="help-inline">${hasErrors(bean: savingsProductInstance, field: 'status', 'error')}</span>
							</div>
						</div>
