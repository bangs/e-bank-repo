	...
	<g:form method="post" class="form-horizontal" >
		...
		<g:hiddenField name="version" value="${productInstance?.version}" />
						...
						<div class="control-group ${hasErrors(bean: productInstance, field: 'institution', 'error')}">
							<label for="institution"><g:message code="product.institution.label" default="Institution" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: productInstance, field: 'shortName', 'error')}">
							<label for="shortName"><g:message code="product.shortName.label" default="Short Name" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: productInstance, field: 'startDate', 'error')}">
							<label for="startDate"><g:message code="product.startDate.label" default="Start Date" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: productInstance, field: 'endDate', 'error')}">
							<label for="endDate"><g:message code="product.endDate.label" default="End Date" /></label>
							<div class="controls">
						...
						<div class="control-group ${hasErrors(bean: productInstance, field: 'applicableFor', 'error')}">
							<label for="applicableFor"><g:message code="product.applicableFor.label" default="Applicable For" /></label>
							<div class="controls">
