...
<section id="create" class="first">
	...
	<g:form action="save" class="form-horizontal" >
							...
							<div class="control-group ${hasErrors(bean: clientInstance, field: 'mobile', 'error')}">
								<label for="mobile" class="control-label"><g:message code="client.mobile.label" default="Mobile" /></label>
				            	<div class="controls">
							...
							<div class="control-group ${hasErrors(bean: clientInstance, field: 'registeredBy', 'error')}">
								<label for="registeredBy" class="control-label"><g:message code="client.registeredBy.label" default="Registered By" /></label>
				            	<div class="controls">
							...
							<div class="control-group ${hasErrors(bean: clientInstance, field: 'branch', 'error')}">
								<label for="branch" class="control-label"><g:message code="client.branch.label" default="Branch" /></label>
				            	<div class="controls">
							...
							<div class="control-group ${hasErrors(bean: clientInstance, field: 'status', 'error')}">
								<label for="status" class="control-label"><g:message code="client.status.label" default="Status" /></label>
				            	<div class="controls">
